...
Notable changes to this Lua fork of `purescript-exceptions` are recorded here. The fork
...
- `Effect.Exception` FFI for Lua 5.1: `catchException`, `throwException`,
  `name`, and `errorWithCause` (#81-#84).
